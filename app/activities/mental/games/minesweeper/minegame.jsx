...
export default function MineGame() {
    ...
    const revealCellRecursive = (board, y, x) => {
            ...
            <Card className="p-6 bg-[#d4f0c5] rounded-lg overflow-hidden max-w-2xl mx-auto">
                ...
                <div className="grid gap-1 mx-auto" style={{
                    ...
                    {board.map((row, y) =>
                        row.map((cell, x) => (
                            <button
                                key={`${y}-${x}`}
                                className={`w-8 h-8 flex items-center justify-center font-bold transition-colors ${getCellColor(cell)}`}
                ...
                <div className="mt-4 flex justify-center">
                    <button
                        ...
                        onClick={() => gameOver ? initializeBoard() : setIsPaused(!isPaused)}
                    >
                ...
                {gameOver && (
                    <div className="mt-6 text-center">
                        ...
                        <p className="text-xl text-[#314328]">Click New Game to play again</p>
                    </div>
                )}
