...
const Marquee = () => {
  return (
    <div data-scroll data-scroll-section data-scroll-speed=".2" className=' w-full py-20   ' style={{ backgroundColor: "#A9C89A"}}>
        ...
        <motion.h1 initial={{x:0}} animate={{x:"-100%"}} transition={{ease:"linear", repeat: Infinity , duration:5}} className='text-[17vw] leading-none mb-5 pt-5'>We are healio</motion.h1>
        <motion.h1 initial={{x:0}} animate={{x:"-100%"}} transition={{ease:"linear", repeat: Infinity , duration:5}} className='text-[17vw] leading-none mb-5 pt-5'>We are healio</motion.h1>
        <motion.h1 initial={{x:0}} animate={{x:"-100%"}} transition={{ease:"linear", repeat: Infinity , duration:5}} className='text-[17vw] leading-none mb-5 pt-5'>We are healio</motion.h1>
        </div>
